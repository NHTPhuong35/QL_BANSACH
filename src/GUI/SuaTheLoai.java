...
public class SuaTheLoai extends JFrame implements MouseListener {

    private JTextField tfTen;
    private JPanel btnXacNhan, btnHuy;
    private TheLoaiGUI tlGUI;
    private LoaiDTO tlDTO;
    
    public SuaTheLoai(LoaiDTO tlDTO, TheLoaiGUI tlGUI) {
        this.tlGUI = tlGUI;
        this.tlDTO = tlDTO;
        this.tfTen = new JTextField(tlDTO.getTenLoai());
    ...
    public void init() {
        ...
        JLabel titleGUI = new JLabel("Sửa Thể Loại", JLabel.CENTER);
        ...
        try {
            ...
            switch (btn.getName()) {
                ...
                case "btnXacNhan":
                    ...
                    tlDTO.setTenLoai(ten);
                    TheLoaiBUS busTL = new TheLoaiBUS();
                    boolean success = true;
                    if (success) {
                        TheLoaiBUS tlBUS = new TheLoaiBUS();
                        if (tlBUS.SuaTheLoai(tlDTO)) {
                            tlGUI.EditRow(tlDTO);
                            dispose();
                        }else{
