...
public class ThemTacGiaGUI extends JFrame implements MouseListener{

    private JTextField tfTen;
    private JPanel btnXacNhan, btnHuy;
    TacGiaGUI TGGUI;

    public ThemTacGiaGUI(TacGiaGUI TGGUI) {
        this.TGGUI = TGGUI;
        init();
    }
	public ThemTacGiaGUI() {
		init();
	}
	...
	public void init() {
	        ...
	        JLabel titleGUI = new JLabel("Thêm Tác Giả", JLabel.CENTER);
        ...
        try {
            ...
            switch (btn.getName()) {
                case "btnHuy":
                    ...
                    break;
                case "btnXacNhan":
                    String TenTG = tfTen.getText();
                    TacGiaDTO tg = new TacGiaDTO("",TenTG); //Phuong sua
                    TacGiaBUS tgBUS = new TacGiaBUS();
                    if(tgBUS.ThemTacGia(tg)) {
                        TGGUI.addRow(tg);
                        dispose();
                    }
                    break;
