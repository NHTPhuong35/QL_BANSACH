...
//        gbc.gridheight = 1; // Take 1 Row
        ...
        GridBagConstraints showPanelgbc = new GridBagConstraints();
        showPanelgbc.fill = GridBagConstraints.BOTH; //Full fill empty space

        PhanQuyenGUI phanquyenGUI = new PhanQuyenGUI();
        
        showPanelgbc.gridx = 0;
        showPanelgbc.gridy = 0;
//        showPanelgbc.gridwidth = 1;  //Take column
//        showPanelgbc.gridheight = 1; //Take row
        showPanelgbc.weightx = 1;
        showPanelgbc.weighty = 1;
        showPanelgbc.fill = GridBagConstraints.BOTH;
        showPanel.add(phanquyenGUI, showPanelgbc);
