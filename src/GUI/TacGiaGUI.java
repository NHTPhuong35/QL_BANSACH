...
public class TacGiaGUI extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
        ...
        } else if (source.getName().equals("btnXoa")){
        	 if (selectedTG == null || selectedTG.getTenTG() == null) {
                 ...
                 if (result == JOptionPane.YES_OPTION) {
                     if (tgBUS.XoaTacGia(selectedTG.getTenTG())) {
                         JOptionPane.showMessageDialog(null,
                                "Đã xoá thành công", "Thông báo", JOptionPane.DEFAULT_OPTION);
                         dsTG.remove(selectedTG);
                         this.remove(tableSPScr);
                         tbl = filterTable(dsTG);
                         tableSPScr = new JScrollPane(tbl);
                         this.add(tableSPScr, BorderLayout.CENTER);
                         selectedTG = new TacGiaDTO();
                         this.revalidate();
                         this.repaint();
